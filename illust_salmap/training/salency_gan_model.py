...
def default_optimization_builder(params_g, params_d):
    return Adam(params_g, lr=0.0001), Adam(params_d, lr=0.0001)
...
class SaliencyGANModel(LightningModule):
    def __init__(
            ...
            criterion: Module = BCEWithLogitsLoss(),
    ...
    def training_step(self, batch, batch_idx, optimizer_idx) -> dict[str, Tensor]:
